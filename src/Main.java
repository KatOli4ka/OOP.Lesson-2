...
public class Main {
    public static void main(String[] args) {
        ...
        printCostOfFlowers(rose,rose,rose,chrysanthemum,chrysanthemum,chrysanthemum,chrysanthemum,chrysanthemum,
                gypsophila);
    ...
    public static void printCostOfFlowers(Flower... flowers) {
        ...
        System.out.println("Стоимость букета цветов: "+totalCost);
